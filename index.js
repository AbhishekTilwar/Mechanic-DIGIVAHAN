...
function renderForm() {
  return `
      <form action="#" class="js-search-form">
        <label for="query"><h2 style="font-family: 'Google Sans', sans-serif;" >Enter a city or zip code</h2></label>
        <input type="text" id="query" class="js-query"  style="font-family: 'Google Sans', sans-serif;" placeholder="Ex: Pune or 411041" required>
        <button  style="font-family: 'Google Sans', sans-serif;" type="submit">Search</button>
      </form>
